def greedy_graph_search(graph, heuristic_costs, start):
    ...
    while True:
        ...
        for neighbor, cost in neighbors.items():
            if neighbor not in visited and heuristic_costs[neighbor] < min_cost:
                min_cost = heuristic_costs[neighbor]
                next_node = neighbor
            elif neighbor not in visited and heuristic_costs[neighbor] == min_cost and neighbor < next_node:
                next_node = neighbor
